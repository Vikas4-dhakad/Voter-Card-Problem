...
if __name__ == "__main__":
    ...
    if not json_path:
        json_path = r"/workspaces/Voter-Card-Problem/Voter_id_web_server/database/database_storage/uid_as_key_dict.json"
    canvas_path = r"/workspaces/Voter-Card-Problem/id_card_genrator/sample.png"
