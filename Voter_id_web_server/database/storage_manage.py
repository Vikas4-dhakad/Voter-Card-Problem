...
class StorageManage:
    def __init__(self):
        self.uid_dict_path = r'/workspaces/Voter-Card-Problem/Voter_id_web_server/database/database_storage/uid_as_key_dict.json'
        self.uid_voterid_path = r'/workspaces/Voter-Card-Problem/Voter_id_web_server/database/database_storage/uid_voterid_list.json'
        self.voted_status_path = r'/workspaces/Voter-Card-Problem/Voter_id_web_server/database/database_storage/voted_status.json'
    ...
    def check_and_mark_voted(self, voter_id: str):
        ...
        """
        voted_status_path = r'/workspaces/Voter-Card-Problem/Voter_id_web_server/database/database_storage/voted_status.json'
